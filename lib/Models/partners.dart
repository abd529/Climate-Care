...
final List<Partners> partners = [
  Partners(
      ...
      location:
          "A block, plot no 61, Izmir Housing Society, Canal Road, Lahore",
      description:
      ...
      offer:
          "Get 50% discout on all items for once by earning 1000 green coins",
  ...
  Partners(
      ...
      offer:
          "Get 50% discout on all items on one bill by earning 1000 green coins",
